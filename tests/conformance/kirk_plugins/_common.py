...
HARNESS_STATUS_PREFIX = "__elfuse_harness_status__:"

# Environment names forwarded from the framework env into the guest.
FORWARD_PREFIXES = ("LTP_", "TST_")


def harness_status(**fields) -> str:
    """One machine-readable record appended after all testcase output."""
    fields["schema_version"] = 1
    return HARNESS_STATUS_PREFIX + json.dumps(
