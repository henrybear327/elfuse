...
// TestRunDispatchHelpVersionAndErrors pins the non-command dispatch
// paths: usage on stderr, version on stdout, and no or unknown commands
...
// TestMainSubprocessExitBehavior pins main's exit codes and stderr prefix
// through a real subprocess; run()-level tests cannot observe os.Exit.
