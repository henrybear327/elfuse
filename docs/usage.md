...
List pinned refs, their manifest digests, platform, creation time, compressed
layer size, and layer count.
...
[Dynamic Linking And Sysroots](#dynamic-linking-and-sysroots) for the
dispatch model.
