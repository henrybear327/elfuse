...
# The interface is a single optional flag; a stray second argument is a
# mistyped invocation, not something to silently ignore.
[ "$#" -le 1 ] || { echo "usage: $0 [--unpack]" >&2; exit 2; }
UNPACK=0
case "${1:-}" in
--unpack) UNPACK=1 ;;
'') ;;
