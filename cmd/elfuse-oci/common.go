...
// platform (pull, and run's pinned-image agreement check). The other
// subcommands must not accept it: a successful parse that discards the flag
// reads as target selection that never happened.
