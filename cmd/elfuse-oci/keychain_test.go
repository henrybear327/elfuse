...
// TestTimedKeychainReportsTimeout pins that a wedged helper surfaces a
// bounded, actionable error rather than a hang.
...
// TestTimedKeychainPassesThroughFastResult pins that a prompt helper's
