# shellcheck shell=sh
# JVM image workload via /bin/sh -c, POSIX sh (dash): javac-compile and run a
# program with the futex/clock_gettime-heavy signature.
set -e
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Fixed inputs, exact expected constants: sum(i*i) for i in 0..999,
        // 350000 per worker (100000 iterations over a full & 7 residue
        // cycle), sha256 of the 65536-byte i & 0xff ramp.
