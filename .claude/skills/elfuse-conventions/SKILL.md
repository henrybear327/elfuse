...
issue, by a person or an agent: a few plain sentences, no longer than the
comment it answers unless it carries a measurement. Use a list only when
the reply answers several separate review points.
